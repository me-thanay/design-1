  ...
  return (
    <section className={cn("w-full py-10 sm:py-14", className)}>
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="no-scrollbar mt-8 -mx-4 flex gap-4 overflow-x-auto px-4 pb-2 pt-1 scroll-smooth sm:mx-0 sm:px-0 sm:gap-5 sm:snap-none sm:overflow-visible snap-x snap-mandatory">
