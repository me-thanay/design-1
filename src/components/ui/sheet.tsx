  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        {showClose && (
          <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute right-5 top-5 rounded-full transition-opacity hover:opacity-100 focus:outline-hidden focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none">
...
function SheetHeader(props: React.ComponentProps<"div">) {
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col gap-1 border-b bg-muted/30 p-4",
        className,
      )}
      {...rest}
    />
