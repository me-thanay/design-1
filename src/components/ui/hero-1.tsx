          ...
          >
            <div className="flex lg:flex-1">
              <a href="/" className="-m-0.5 p-0.5">
                ...
                <img
                  alt={logo?.alt}
                  src={logo?.src}
                  className="h-14 w-auto rounded-sm sm:h-[4.25rem] md:h-[4.75rem]"
            ...
            <div className="hidden lg:flex lg:flex-1 lg:justify-center">
              <form
                ...
                method="get"
                className={[
                  "flex w-full max-w-xs items-center gap-2 rounded-full border px-2.5 py-1 backdrop-blur",
                  hasImageBackground
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p
              className={[
                ...
                "text-base sm:text-lg font-medium text-pretty sm:text-xl/8",
