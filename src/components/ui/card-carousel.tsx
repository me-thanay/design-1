      ...
      <div className="relative left-1/2 w-screen max-w-[100vw] -translate-x-1/2 overflow-x-hidden overflow-y-visible px-0 sm:px-2">
        <div className="relative mx-auto max-w-[100vw] px-2 sm:px-12 md:px-16">
          {showNavigation && loopSlides.length > 1 ? (
            <>
              <div className="swiper-button-prev home-bs-prev !left-1 !top-[40%] z-20 sm:!left-3 md:!left-6" />
              <div className="swiper-button-next home-bs-next !right-1 !top-[40%] z-20 sm:!right-3 md:!right-6" />
            </>
          ) : null}
          ...
          >
            {loopSlides.map(({ slide, reactKey }) => (
              <SwiperSlide key={reactKey}>
                <article className="home-bs-card flex h-full flex-col overflow-hidden rounded-2xl bg-neutral-900 shadow-xl ring-1 ring-black/20">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 space-y-2.5 p-4 text-left text-white sm:p-5">
                        {slide.kind === "product" ? (
                          <>
                            ...
                            <p className="line-clamp-3 text-xs leading-relaxed text-white/85 sm:text-sm">
                          ...
                          <>
                            ...
                            <p className="line-clamp-3 text-xs text-white/85 sm:text-sm">{slide.description}</p>
                            <div className="flex flex-wrap items-center gap-2 text-xs sm:text-sm">
